    ...
    <script>
        $('document').ready(function(){
            ...
            function resizeDiv() {
                ...
                //$('#container').css({'height':vph-200+'px'})
                        ...
                        <div class="tab-pane active" id="Ward">
                                                <table id="tbl" class="display" cellspacing="0">
                                                    ...
                                                    foreach ($Requests as $value) {
                                                        ...
                                                        if($value->status != "Sample Collected" && $value->status != "Sample Required" && $value->flab_ID->lab_Name =="OPD"){
                                                        ?>
                                                ...
                                                <table id="tbl2" class="display" cellspacing="0">
                                                    ...
                                                    foreach ($Requests as $value) {
                                                        ...
                                                        <tr id="<?php echo $value->ftest_ID->test_ID; ?>">
                                                            ...
                                                            <td><?php echo $value->comment; ?></td>
                                                            <td><?php echo $value->priority; ?></td>
                                                            <td><?php if ($value->status == "Report Issued"){echo $value->status; } ?></td>
                                                    ...
                                                    foreach ($Requests as $value) {
                                                        ...
                                                        <tr id="<?php echo $value->ftest_ID->test_ID; ?>">
                                                           ...
                                                           <!-- <td><?php /*echo $value->wardCOP_ID; */?></td>-->
                                                            <td><?php echo $value->comment; ?></td>
                                                            <td><?php echo $value->priority; ?></td>
                                                            <?php if ($value->status == "Report Issued"){
                                                                            echo $value->status; 
                                                                        }
                                                                       else{
                                                                            $value->status == "";
