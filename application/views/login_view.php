...
?>
        <img src="<?php echo base_url(); ?>assets/images/mri_logo.png" style="width:600px;" class="img-responsive center-block"/>
    </div><!-- /.login-logo -->
    <div class="login-box-body">
        <?php echo validation_errors(); ?>
        <p class="login-box-msg">Sign in to start your session</p>
        Login
        <form action="<?php echo(base_url().'login_controller/login_validate') ?>" method="post">
